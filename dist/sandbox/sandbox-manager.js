...
function getCredentialRestrictions(credentials, allowedDomains) {
    ...
    const { setEnvVars, degradeToUnsetNames } = buildMaskedEnvVars(credentials.envVars ?? [], allowedDomains ?? [], sentinelRegistry);
    ...
    registerAwsPairs(credentials.envVars ?? [], credentials.awsPairs, allowedDomains ?? [], setEnvVars, awsPairRegistry);
