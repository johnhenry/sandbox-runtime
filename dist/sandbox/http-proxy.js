        ...
        try {
            ...
            if (options.mitmCA &&
                ...
                if (clientGone)
                    return;
                if (peeked.isTLS) {
                    terminateAndForward(options.mitmCA, options.filterRequest, options.mutateHeaders, options.getBodySubstitutions, socket, peeked.head, { hostname, port, upstreamCA: options.tlsTerminateUpstreamCA }, options.planSigv4, options.maxSigv4ResignBodyBytes);
                    return;
                }
