...
export const SrtWinConfigSchema = z.object({
    path: z
        ...
        .min(1)
        .optional()
        .describe('Path to the srt-win binary. When unset, getSrtWinPath() resolves ' +
...
export const WindowsConfigSchema = z.object({
    ...
    srtWin: SrtWinConfigSchema.optional().describe('How to locate/invoke the srt-win helper binary. Omit to resolve the ' +
